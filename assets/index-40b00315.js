 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ss(e){var t;const n=e.auth,r=await e.getIdToken(),i=await Ui(e,mm(n,{idToken:r}));A(i==null?void 0:i.users.length,n,"internal-error");const o=i.users[0];e._notifyReloadListener(o);const s=!((t=o.providerUserInfo)===null||t===void 0)&&t.length?gm(o.providerUserInfo):[],a=iw(e.providerData,s),l=e.isAnonymous,u=!(e.email&&o.passwordHash)&&!(a!=null&&a.length),d=l?u:!1,f={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:a,metadata:new Ql(o.createdAt,o.lastLoginAt),isAnonymous:d};Object.assign(e,f)}async function rw(e){const t=ye(e);await Ss(t),await t.auth._persistUserIfCurrent(t),t.auth._notifyListenersIfCurrent(t)}function iw(e,t){return[...e.filter(r=>!t.some(i=>i.providerId===r.providerId)),...t]}function gm(e){return e.map(t=>{var{providerId:n}=t,r=ac(t,["providerId"]);return{providerId:n,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function IS(e,t,n){let r=1,i=null,o=null,s=!1,a=0;function l(){return a===2}let u=!1;function d(...P){u||(u=!0,t.apply(null,P))}function f(P){i=setTimeout(()=>{i=null,e(v,l())},P)}function m(){o&&clearTimeout(o)}function v(P,...p){if(u){m();return}if(P){m(),d.call(null,P,...p);return}if(l()||s){m(),d.call(null,P,...p);return}r<64&&(r*=2);let h;a===1?(a=2,h=0):h=(r+Math.random())*1e3,f(h)}let y=!1;function _(P){y||(y=!0,m(),!u&&(i!==null?(P||(a=2),clearTimeout(i),f(0)):P||(a=1)))}return f(0),o=setTimeout(()=>{s=!0,_(!0)},n),_}function TS(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,m=`\r
--`+l+"--",v=qt.getBlob(f,r,m);if(v===null)throw Gm();const y={name:u.fullPath},_=mn(o,e.host,e._protocol),P="POST",p=e.maxUploadRetryTime,c=new Lt(_,P,Xs(e,n),p);return c.urlParams=y,c.headers=s,c.body=v.uploadData(),c.errorHandler=Fr(t),c}class Ts{constructor(t,n,r,i){this.current=t,this.total=n,this.finalized=!!r,this.metadata=i||null}}function Sc(e,t){let n=null;try{n=e.getResponseHeader("X-Goog-Upload-Status")}catch{ht(!1)}return ht(!!n&&(t||["active"]).indexOf(n)!==-1),n}function aE(e,t,n,r,i){const o=t.bucketOnlyServerUrl(),s=ng(t,r,i),a={name:s.fullPath},l=mn(o,e.host,e._protocol),u="POST",d={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${r.size()}`,"X-Goog-Upload-Header-Content-Type":s.contentType,"Content-Type":"application/json; charset=utf-8"},f=wc(s,n),m=e.maxUploadRetryTime;function v(_){Sc(_);let P;try{P=_.getResponseHeader("X-Goog-Upload-URL")}catch{ht(!1)}return ht(Ys(P)),P}const y=new Lt(l,u,v,m);return y.urlParams=a,y.headers=d,y.body=f,y.errorHandler=Fr(t),y}function lE(e,t,n,r){const i={"X-Goog-Upload-Command":"query"};function o(u){const d=Sc(u,["active","final"]);let f=null;try{f=u.getResponseHeader("X-Goog-Upload-Size-Received")}catch{ht(!1)}f||ht(!1);const m=Number(f);return ht(!isNaN(m)),new Ts(m,r.size(),d==="final")}const s="POST",a=e.maxUploadRetryTime,l=new Lt(n,s,o,a);return l.headers=i,l.errorHandler=Fr(t),l}const wf=256*1024;function uE(e,t,n,r,i,o,s,a){const l=new Ts(0,0);if(s?(l.current=s.current,l.total=s.total):(l.current=0,l.total=r.size()),r.size()!==l.total)throw _S();const u=l.total-l.current;let d=u;i>0&&(d=Math.min(d,i));const f=l.current,m=f+d;let v="";d===0?v="finalize":u===d?v="upload, finalize":v="upload";const y={"X-Goog-Upload-Command":v,"X-Goog-Upload-Offset":`${l.current}`},_=r.slice(f,m);if(_===null)throw Gm();function P(g,E){const S=Sc(g,["active","final"]),w=l.current+d,T=r.size();let M;return S==="final"?M=Xs(t,o)(g,E):M=null,new Ts(w,T,S==="final",M)}const p="POST",c=t.maxUploadRetryTime,h=new Lt(n,p,P,c);return h.headers=y,h.body=_.uploadData(),h.progressCallback=a||null,h.errorHandler=Fr(e),h}const Te={RUNNING:"running",PAUSED:"paused",SUCCESS:"success",CANCELED:"canceled",ERROR:"error"};function ja(e){switch(e){case"running":case"pausing":case"canceling":return Te.RUNNING;case"paused":return Te.PAUSED;case"success":return Te.SUCCESS;case"canceled":return Te.CANCELED;case"error":return Te.ERROR;default:return Te.ERROR}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,nI=""+new URL("splash-79c3946f.mp4",import.meta.url).href,rI=({onEnded:e})=>{const t=b.useRef(null);return I("div",{style:{width:"100vw",height:"100vh",display:"flex",justifyContent:"center",alignItems:"center",backgroundColor:"white"},children:I("video",{onEnded:e,ref:t,autoPlay:!0,muted:!0,playsInline:!0,src:nI,style:{width:"100%",height:"100%",maxWidth:"900px"}})})},iI=b.lazy(()=>sS(()=>import("./index-f9f65f3e.js"),[],import.meta.url)),oI=()=>{const[e,t]=b.useState(0),n=b.useContext(rc),[r,i]=b.useState(Ff()),[o,s]=b.useState(null);if(b.useEffect(()=>{(async()=>{const f=await UE(),m=zf(f,r);s(m)})()},[]),b.useEffect(()=>{const d=()=>{const f=Ff();i(f)};return window.addEventListener("resize",d),()=>{window.removeEventListener("resize",d)}},[]),b.useEffect(()=>{if(!o)return;const d=zf(o.flat(),r);s(d)},[r]),e>=10&&!n)return I(Kk,{});const a=()=>{t(0),gc.signOut()},[l,u]=b.useState(!1);return!o||!l?I(rI,{onEnded:()=>u(!0)}):ne(Ln,{children:[ne(Jk,{children:[I(eI,{onClick:()=>t(e+1),children:I("img",{src:aS,alt:"are we cool yet t-shirt"})}),I(Xk,{onClick:()=>t(e+1),children:"arewecoolyet.blog"}),I(Qk,{children:"YOU'RE ALL WELCOME"}),I(tI,{controlsList:"nodownload noplaybackrate",controls:!0,src:gf,children:I("track",{default:!0,kind:"captions",src:gf})}),n&&ne(Ln,{children:[I(qk,{onUpload:d=>{if(!o){s([[d]]);return}const f=o[o.length-1];s([...o.slice(0,-1),[...f,d]])}}),I("button",{onClick:a,children:"Log out"})]})]}),I(jk,{children:I(Hk,{children:o&&o.map(d=>I(Wk,{children:d.map(f=>I(b.Suspense,{fallback:I($k,{}),children:I(iI,{content:f,onDelete:m=>{const v=o.map(y=>y.filter(_=>_!==m));s(v)}})},f.downloadUrl))},d[0].downloadUrl))})})]})};var It=(e=>(e.LOGIN="login",e.CLUB="club",e.HOME="home",e))(It||{});const Dg={name:"",stats:null,outfit:null,stage:It.LOGIN,update:()=>{}},eo=b.createContext(Dg),sI=({children:e})=>{const[t,n]=b.useState(Dg),r=b.useCallback(o=>{n({...t,...o})},[t]),i={...t,update:r};return I(eo.Provider,{value:i,children:e})},aI=""+new URL("bouncer-da71ab54.png",import.meta.url).href,bg=""+new URL("character-cc76f9ba.png",import.meta.url).href,lI=""+new URL("club-e196994d.jpg",import.meta.url).href,lu="data:image/png;base64,",uI=D.div`
  display: flex;
  justify-content: center;
  align-items: center;
  width: 80%;
...
`,wI=()=>{const{stage:e,update:t}=b.useContext(eo);return ne(Ln,{children:[I(Ug,{src:lI,alt:"club"}),I(Mg,{$stage:e,src:bg,alt:"character"}),I(mI,{src:aI,alt:"bouncer"}),I(gI,{onClick:()=>t({stage:It.HOME}),children:">"})]})},SI=()=>{const{name:e,update:t}=b.useContext(eo);return ne(Ln,{children:[ne(hI,{children:[I("p",{children:"AWCY"}),I("p",{children:"version 1.0"})]}),ne(pI,{onSubmit:r=>{r.preventDefault(),e&&t({name:e,stage:It.CLUB})},children:[I("label",{htmlFor:"name",children:"Select character name:"}),I("input",{required:!0,id:"name",onChange:r=>t({name:r.target.value}),value:e}),I("button",{type:"submit",children:"Play"})]})]})},EI=({stats:e})=>ne(_I,{children:[ne(Bf,{$stat:"health",max:"100",value:e.health,children:["Health: ",e.health]}),ne(Bf,{$stat:"clout",max:"100",value:e.clout,children:["Clout: ",e.clout]})]}),kI=""+new URL("room-005b6ed8.jpg",import.meta.url).href,II=()=>{const{stage:e,update:t}=b.useContext(eo),[n,r]=b.useState(!1),i=()=>{t({stats:null}),r(!0)},o=()=>{r(!1),t({stats:{health:80,clout:80}})};return ne(Ln,{children:[I(vI,{onClick:()=>t({stage:It.CLUB}),children:"<"}),I(Ug,{src:kI,alt:"home",onClick:i}),I(Mg,{$stage:e,src:bg,alt:"character"}),n&&ne(yI,{children:[I(Ka,{onClick:o,src:"",alt:"outfit-1"}),I(Ka,{onClick:o,src:"",alt:"outfit-2"}),I(Ka,{onClick:o,src:"",alt:"outfit-3"})]})]})},TI=()=>{const{stats:e,stage:t}=b.useContext(eo);return I(uI,{children:I(cI,{children:I(dI,{children:ne(fI,{children:[t===It.LOGIN&&I(SI,{}),t===It.CLUB&&I(wI,{}),t===It.HOME&&I(II,{}),e&&t!==It.LOGIN&&I(EI,{stats:e})]})})})})},CI=()=>b.useContext(rc)?I(sI,{children:I(TI,{})}):null,RI=()=>ne(rS,{children:[I(oI,{}),I(CI,{})]});Ya.createRoot(document.getElementById("root")).render(I(RI,{}));export{Mk as A,DI as B,bI as C,AI as D,NI as E,Ln as F,UI as M,Fk as S,rc as U,I as a,OI as b,MI as c,PI as d,LI as e,ne as j,b as r,xI as u};
