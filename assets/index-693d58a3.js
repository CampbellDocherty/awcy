 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ss=new sm("@firebase/auth");function q_(e,...t){Ss.logLevel<=H.WARN&&Ss.warn(`Auth (${Dr}): ${e}`,...t)}function zo(e,...t){Ss.logLevel<=H.ERROR&&Ss.error(`Auth (${Dr}): ${e}`,...t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,m=`\r
--`+l+"--",v=qt.getBlob(f,r,m);if(v===null)throw Qm();const y={name:u.fullPath},_=mn(o,e.host,e._protocol),P="POST",p=e.maxUploadRetryTime,c=new Lt(_,P,Js(e,n),p);return c.urlParams=y,c.headers=s,c.body=v.uploadData(),c.errorHandler=Fr(t),c}class Cs{constructor(t,n,r,i){this.current=t,this.total=n,this.finalized=!!r,this.metadata=i||null}}function Ec(e,t){let n=null;try{n=e.getResponseHeader("X-Goog-Upload-Status")}catch{ht(!1)}return ht(!!n&&(t||["active"]).indexOf(n)!==-1),n}function dE(e,t,n,r,i){const o=t.bucketOnlyServerUrl(),s=sg(t,r,i),a={name:s.fullPath},l=mn(o,e.host,e._protocol),u="POST",d={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${r.size()}`,"X-Goog-Upload-Header-Content-Type":s.contentType,"Content-Type":"application/json; charset=utf-8"},f=Sc(s,n),m=e.maxUploadRetryTime;function v(_){Ec(_);let P;try{P=_.getResponseHeader("X-Goog-Upload-URL")}catch{ht(!1)}return ht(Qs(P)),P}const y=new Lt(l,u,v,m);return y.urlParams=a,y.headers=d,y.body=f,y.errorHandler=Fr(t),y}function fE(e,t,n,r){const i={"X-Goog-Upload-Command":"query"};function o(u){const d=Ec(u,["active","final"]);let f=null;try{f=u.getResponseHeader("X-Goog-Upload-Size-Received")}catch{ht(!1)}f||ht(!1);const m=Number(f);return ht(!isNaN(m)),new Cs(m,r.size(),d==="final")}const s="POST",a=e.maxUploadRetryTime,l=new Lt(n,s,o,a);return l.headers=i,l.errorHandler=Fr(t),l}const wf=256*1024;function hE(e,t,n,r,i,o,s,a){const l=new Cs(0,0);if(s?(l.current=s.current,l.total=s.total):(l.current=0,l.total=r.size()),r.size()!==l.total)throw kS();const u=l.total-l.current;let d=u;i>0&&(d=Math.min(d,i));const f=l.current,m=f+d;let v="";d===0?v="finalize":u===d?v="upload, finalize":v="upload";const y={"X-Goog-Upload-Command":v,"X-Goog-Upload-Offset":`${l.current}`},_=r.slice(f,m);if(_===null)throw Qm();function P(g,E){const S=Ec(g,["active","final"]),w=l.current+d,T=r.size();let M;return S==="final"?M=Js(t,o)(g,E):M=null,new Cs(w,T,S==="final",M)}const p="POST",c=t.maxUploadRetryTime,h=new Lt(n,p,P,c);return h.headers=y,h.body=_.uploadData(),h.progressCallback=a||null,h.errorHandler=Fr(e),h}const Te={RUNNING:"running",PAUSED:"paused",SUCCESS:"success",CANCELED:"canceled",ERROR:"error"};function Ha(e){switch(e){case"running":case"pausing":case"canceling":return Te.RUNNING;case"paused":return Te.PAUSED;case"success":return Te.SUCCESS;case"canceled":return Te.CANCELED;case"error":return Te.ERROR;default:return Te.ERROR}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,AI=()=>{const{stage:e,update:t}=b.useContext(to);return ne(Ln,{children:[I($g,{src:yI,alt:"club"}),I(Bg,{$stage:e,src:zg,alt:"character"}),I(TI,{src:vI,alt:"bouncer"}),I(CI,{onClick:()=>t({stage:It.HOME}),children:">"})]})},OI=()=>{const{name:e,update:t}=b.useContext(to);return ne(Ln,{children:[ne(kI,{children:[I("p",{children:"AWCY"}),I("p",{children:"version 1.0"})]}),ne(II,{onSubmit:r=>{r.preventDefault(),e&&t({name:e,stage:It.CLUB})},children:[I("label",{htmlFor:"name",children:"Select character name:"}),I("input",{required:!0,id:"name",onChange:r=>t({name:r.target.value}),value:e}),I("button",{type:"submit",children:"Play"})]})]})},NI=({stats:e})=>ne(xI,{children:[ne(Vf,{$stat:"health",max:"100",value:e.health,children:["Health: ",e.health]}),ne(Vf,{$stat:"clout",max:"100",value:e.clout,children:["Clout: ",e.clout]})]}),LI=""+new URL("room-005b6ed8.jpg",import.meta.url).href,bI=()=>{const{stage:e,update:t}=b.useContext(to),[n,r]=b.useState(!1),i=()=>{t({stats:null}),r(!0)},o=()=>{r(!1),t({stats:{health:80,clout:80}})};return ne(Ln,{children:[I(RI,{onClick:()=>t({stage:It.CLUB}),children:"<"}),I($g,{src:LI,alt:"home",onClick:i}),I(Bg,{$stage:e,src:zg,alt:"character"}),n&&ne(PI,{children:[I(Ya,{onClick:o,src:"",alt:"outfit-1"}),I(Ya,{onClick:o,src:"",alt:"outfit-2"}),I(Ya,{onClick:o,src:"",alt:"outfit-3"})]})]})},DI=()=>{const{stats:e,stage:t}=b.useContext(to);return I(_I,{children:I(wI,{children:I(SI,{children:ne(EI,{children:[t===It.LOGIN&&I(OI,{}),t===It.CLUB&&I(AI,{}),t===It.HOME&&I(bI,{}),e&&t!==It.LOGIN&&I(NI,{stats:e})]})})})})},UI=()=>b.useContext(ic)?I(gI,{children:I(DI,{})}):null,MI=()=>ne(aS,{children:[I(mI,{}),I(UI,{})]});Qa.createRoot(document.getElementById("root")).render(I(MI,{}));export{Bk as A,WI as B,VI as C,$I as D,jI as E,Ln as F,GI as M,jk as S,ic as U,I as a,BI as b,qI as c,FI as d,HI as e,ne as j,b as r,zI as u};
