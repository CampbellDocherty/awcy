...
`,xI=()=>{const{stage:e,update:t}=b.useContext(eo);return ne(Ln,{children:[I($g,{src:vI,alt:"club"}),I(Bg,{$stage:e,src:zg,alt:"character"}),I(II,{src:gI,alt:"bouncer"}),I(TI,{onClick:()=>t({stage:It.HOME}),children:">"})]})},AI=()=>{const{name:e,update:t}=b.useContext(eo);return ne(Ln,{children:[ne(EI,{children:[I("p",{children:"AWCY"}),I("p",{children:"version 1.0"})]}),ne(kI,{onSubmit:r=>{r.preventDefault(),e&&t({name:e,stage:It.CLUB})},children:[I("label",{htmlFor:"name",children:"Select character name:"}),I("input",{required:!0,id:"name",onChange:r=>t({name:r.target.value}),value:e}),I("button",{type:"submit",children:"Play"})]})]})},OI=({stats:e})=>ne(PI,{children:[ne(Vf,{$stat:"health",max:"100",value:e.health,children:["Health: ",e.health]}),ne(Vf,{$stat:"clout",max:"100",value:e.clout,children:["Clout: ",e.clout]})]}),NI=""+new URL("room-005b6ed8.jpg",import.meta.url).href,LI=()=>{const{stage:e,update:t}=b.useContext(eo),[n,r]=b.useState(!1),i=()=>{t({stats:null}),r(!0)},o=()=>{r(!1),t({stats:{health:80,clout:80}})};return ne(Ln,{children:[I(CI,{onClick:()=>t({stage:It.CLUB}),children:"<"}),I($g,{src:NI,alt:"home",onClick:i}),I(Bg,{$stage:e,src:zg,alt:"character"}),n&&ne(RI,{children:[I(Ya,{onClick:o,src:"",alt:"outfit-1"}),I(Ya,{onClick:o,src:"",alt:"outfit-2"}),I(Ya,{onClick:o,src:"",alt:"outfit-3"})]})]})},bI=()=>{const{stats:e,stage:t}=b.useContext(eo);return I(yI,{children:I(_I,{children:I(wI,{children:ne(SI,{children:[t===It.LOGIN&&I(AI,{}),t===It.CLUB&&I(xI,{}),t===It.HOME&&I(LI,{}),e&&t!==It.LOGIN&&I(OI,{stats:e})]})})})})},DI=()=>b.useContext(ic)?I(mI,{children:I(bI,{})}):null,UI=()=>ne(aS,{children:[I(pI,{}),I(DI,{})]});Qa.createRoot(document.getElementById("root")).render(I(UI,{}));export{Bk as A,HI as B,WI as C,zI as D,BI as E,Ln as F,VI as M,jk as S,ic as U,I as a,$I as b,GI as c,MI as d,jI as e,ne as j,b as r,FI as u};
