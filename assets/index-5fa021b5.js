 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ss(e){var t;const n=e.auth,r=await e.getIdToken(),i=await Ui(e,mm(n,{idToken:r}));A(i==null?void 0:i.users.length,n,"internal-error");const o=i.users[0];e._notifyReloadListener(o);const s=!((t=o.providerUserInfo)===null||t===void 0)&&t.length?gm(o.providerUserInfo):[],a=iw(e.providerData,s),l=e.isAnonymous,u=!(e.email&&o.passwordHash)&&!(a!=null&&a.length),d=l?u:!1,h={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:a,metadata:new Ql(o.createdAt,o.lastLoginAt),isAnonymous:d};Object.assign(e,h)}async function rw(e){const t=ye(e);await Ss(t),await t.auth._persistUserIfCurrent(t),t.auth._notifyListenersIfCurrent(t)}function iw(e,t){return[...e.filter(r=>!t.some(i=>i.providerId===r.providerId)),...t]}function gm(e){return e.map(t=>{var{providerId:n}=t,r=ac(t,["providerId"]);return{providerId:n,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Se{constructor(t,n){this.bucket=t,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const t=encodeURIComponent;return"/b/"+t(this.bucket)+"/o/"+t(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(t,n){let r;try{r=Se.makeFromUrl(t,n)}catch{return new Se(t,"")}if(r.path==="")return r;throw vS(t)}static makeFromUrl(t,n){let r=null;const i="([A-Za-z0-9.\\-_]+)";function o(g){g.path.charAt(g.path.length-1)==="/"&&(g.path_=g.path_.slice(0,-1))}const s="(/(.*))?$",a=new RegExp("^gs://"+i+s,"i"),l={bucket:1,path:3};function u(g){g.path_=decodeURIComponent(g.path)}const d="v[A-Za-z0-9_]+",h=n.replace(/[.]/g,"\\."),m="(/([^?#]*).*)?$",v=new RegExp(`^https?://${h}/${d}/b/${i}/o${m}`,"i"),y={bucket:1,path:3},_=n===jm?"(?:storage.googleapis.com|storage.cloud.google.com)":n,P="([^?#]*)",p=new RegExp(`^https?://${_}/${i}/${P}`,"i"),f=[{regex:a,indices:l,postModify:o},{regex:v,indices:y,postModify:u},{regex:p,indices:{bucket:1,path:2},postModify:u}];for(let g=0;g<f.length;g++){const E=f[g],S=E.regex.exec(t);if(S){const w=S[E.indices.bucket];let T=S[E.indices.path];T||(T=""),r=new Se(w,T),E.postModify(r);break}}if(r==null)throw gS(t);return r}}class kS{constructor(t){this.promise_=Promise.reject(t)}getPromise(){return this.promise_}cancel(t=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function IS(e,t,n){let r=1,i=null,o=null,s=!1,a=0;function l(){return a===2}let u=!1;function d(...P){u||(u=!0,t.apply(null,P))}function h(P){i=setTimeout(()=>{i=null,e(v,l())},P)}function m(){o&&clearTimeout(o)}function v(P,...p){if(u){m();return}if(P){m(),d.call(null,P,...p);return}if(l()||s){m(),d.call(null,P,...p);return}r<64&&(r*=2);let f;a===1?(a=2,f=0):f=(r+Math.random())*1e3,h(f)}let y=!1;function _(P){y||(y=!0,m(),!u&&(i!==null?(P||(a=2),clearTimeout(i),h(0)):P||(a=1)))}return h(0),o=setTimeout(()=>{s=!0,_(!0)},n),_}function TS(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,m=`\r
--`+l+"--",v=qt.getBlob(h,r,m);if(v===null)throw Gm();const y={name:u.fullPath},_=mn(o,e.host,e._protocol),P="POST",p=e.maxUploadRetryTime,c=new Lt(_,P,Xs(e,n),p);return c.urlParams=y,c.headers=s,c.body=v.uploadData(),c.errorHandler=Fr(t),c}class Ts{constructor(t,n,r,i){this.current=t,this.total=n,this.finalized=!!r,this.metadata=i||null}}function Sc(e,t){let n=null;try{n=e.getResponseHeader("X-Goog-Upload-Status")}catch{ht(!1)}return ht(!!n&&(t||["active"]).indexOf(n)!==-1),n}function aE(e,t,n,r,i){const o=t.bucketOnlyServerUrl(),s=ng(t,r,i),a={name:s.fullPath},l=mn(o,e.host,e._protocol),u="POST",d={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${r.size()}`,"X-Goog-Upload-Header-Content-Type":s.contentType,"Content-Type":"application/json; charset=utf-8"},h=wc(s,n),m=e.maxUploadRetryTime;function v(_){Sc(_);let P;try{P=_.getResponseHeader("X-Goog-Upload-URL")}catch{ht(!1)}return ht(Ys(P)),P}const y=new Lt(l,u,v,m);return y.urlParams=a,y.headers=d,y.body=h,y.errorHandler=Fr(t),y}function lE(e,t,n,r){const i={"X-Goog-Upload-Command":"query"};function o(u){const d=Sc(u,["active","final"]);let h=null;try{h=u.getResponseHeader("X-Goog-Upload-Size-Received")}catch{ht(!1)}h||ht(!1);const m=Number(h);return ht(!isNaN(m)),new Ts(m,r.size(),d==="final")}const s="POST",a=e.maxUploadRetryTime,l=new Lt(n,s,o,a);return l.headers=i,l.errorHandler=Fr(t),l}const wf=256*1024;function uE(e,t,n,r,i,o,s,a){const l=new Ts(0,0);if(s?(l.current=s.current,l.total=s.total):(l.current=0,l.total=r.size()),r.size()!==l.total)throw _S();const u=l.total-l.current;let d=u;i>0&&(d=Math.min(d,i));const h=l.current,m=h+d;let v="";d===0?v="finalize":u===d?v="upload, finalize":v="upload";const y={"X-Goog-Upload-Command":v,"X-Goog-Upload-Offset":`${l.current}`},_=r.slice(h,m);if(_===null)throw Gm();function P(g,E){const S=Sc(g,["active","final"]),w=l.current+d,T=r.size();let U;return S==="final"?U=Xs(t,o)(g,E):U=null,new Ts(w,T,S==="final",U)}const p="POST",c=t.maxUploadRetryTime,f=new Lt(n,p,P,c);return f.headers=y,f.body=_.uploadData(),f.progressCallback=a||null,f.errorHandler=Fr(e),f}const Te={RUNNING:"running",PAUSED:"paused",SUCCESS:"success",CANCELED:"canceled",ERROR:"error"};function ja(e){switch(e){case"running":case"pausing":case"canceling":return Te.RUNNING;case"paused":return Te.PAUSED;case"success":return Te.SUCCESS;case"canceled":return Te.CANCELED;case"error":return Te.ERROR;default:return Te.ERROR}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,Qk=()=>I(qk,{children:I(Kk,{children:I(Yk,{})})}),Xk=D.form`
  display: flex;
  flex-direction: column;
  gap: 10px;
  margin-bottom: 30px;
  justify-content: center;
  align-items: center;
`,Jk=""+new URL("plus-70c42e58.svg",import.meta.url).href,Zk=({onUpload:e})=>{const[t,n]=M.useState(!1),[r,i]=M.useState(""),[o,s]=M.useState(""),[a,l]=M.useState(null);return ne(Ln,{children:[I(Vk,{onClick:()=>n(!t),src:Jk,alt:"Add more content"}),t&&I(Ln,{children:ne(Xk,{onSubmit:async h=>{if(h.preventDefault(),a){const m=await bE(a,{name:o,caption:r});e(m),l(null),i(""),s(""),n(!1)}},children:[I("div",{children:I("label",{htmlFor:"caption",children:"Caption"})}),ne("div",{children:[I("input",{id:"caption",value:r,onChange:h=>i(h.target.value)}),I("div",{children:I("label",{htmlFor:"name",children:"Name"})}),I("div",{children:I("input",{id:"name",value:o,onChange:h=>s(h.target.value),required:!0})})]}),I("div",{children:I("label",{htmlFor:"file",children:"Choose a file"})}),I("div",{children:I("input",{id:"file",type:"file",required:!0,onChange:h=>{h.target.files&&l(h.target.files[0])}})}),a&&I("button",{type:"submit",children:"Upload a file"})]})})]})},eI=()=>{const[e,t]=M.useState("eantwibawua1@gmail.com"),[n,r]=M.useState("");return ne("div",{children:[I("h1",{children:"Hey Eman 🙂"}),I("p",{children:"Please sign-in:"}),ne("form",{onSubmit:async o=>{o.preventDefault(),await nS(e,n)},children:[ne("div",{children:[I("label",{htmlFor:"email-address",children:"Email address"}),I("input",{type:"email",id:"email-address",value:e,onChange:o=>t(o.target.value),required:!0,placeholder:"Email address"})]}),ne("div",{children:[I("label",{htmlFor:"password",children:"Password"}),I("input",{type:"password",id:"password",value:n,onChange:o=>r(o.target.value),required:!0,placeholder:"Password"})]}),I("button",{type:"submit",children:"Sign in"})]})]})},Mf=(e,t)=>{const n=Math.floor(e.length/t),r=e.length%t;let i=0;const o=[];for(let s=0;s<t;s++){const a=i+n+(s<r?1:0);o.push(e.slice(i,a)),i=a}return o},Ff=990,tI=1320,zf=()=>window.innerWidth<=Ff?2:window.innerWidth<=tI&&window.innerWidth>Ff?3:4,nI=M.lazy(()=>sS(()=>import("./index-ea749201.js"),[],import.meta.url)),rI=()=>{const[e,t]=M.useState(0),n=M.useContext(rc),[r,i]=M.useState(zf()),[o,s]=M.useState(null);return M.useEffect(()=>{(async()=>{const u=await UE(),d=Mf(u,r);s(d)})()},[]),M.useEffect(()=>{const l=()=>{const u=zf();i(u)};return window.addEventListener("resize",l),()=>{window.removeEventListener("resize",l)}},[]),M.useEffect(()=>{if(!o)return;const l=Mf(o.flat(),r);s(l)},[r]),e>=10&&!n?I(eI,{}):ne(Ln,{children:[ne(Fk,{children:[I($k,{onClick:()=>t(e+1),children:I("img",{src:aS,alt:"are we cool yet t-shirt"})}),I(Mk,{onClick:()=>t(e+1),children:"arewecoolyet.blog"}),I(Uk,{children:"YOU'RE ALL WELCOME"}),I(Bk,{controlsList:"nodownload noplaybackrate",controls:!0,src:gf,children:I("track",{default:!0,kind:"captions",src:gf})}),n&&ne(Ln,{children:[I(Zk,{onUpload:l=>{if(!o){s([[l]]);return}const u=o[o.length-1];s([...o.slice(0,-1),[...u,l]])}}),I("button",{onClick:()=>{t(0),gc.signOut()},children:"Log out"})]})]}),I(jk,{children:I(Hk,{children:o&&o.map(l=>I(Wk,{children:l.map(u=>I(M.Suspense,{fallback:I(Qk,{}),children:I(nI,{content:u,onDelete:d=>{const h=o.map(m=>m.filter(v=>v!==d));s(h)}})},u.downloadUrl))},l[0].downloadUrl))})})]})};var It=(e=>(e.LOGIN="login",e.CLUB="club",e.HOME="home",e))(It||{});const Dg={name:"",stats:null,outfit:null,stage:It.LOGIN,update:()=>{}},eo=M.createContext(Dg),iI=({children:e})=>{const[t,n]=M.useState(Dg),r=M.useCallback(o=>{n({...t,...o})},[t]),i={...t,update:r};return I(eo.Provider,{value:i,children:e})},oI=""+new URL("bouncer-da71ab54.png",import.meta.url).href,bg=""+new URL("character-cc76f9ba.png",import.meta.url).href,sI=""+new URL("club-e196994d.jpg",import.meta.url).href,lu="data:image/png;base64,",aI=D.div`
  display: flex;
  justify-content: center;
  align-items: center;
  width: 80%;
...
`,yI=()=>{const{stage:e,update:t}=M.useContext(eo);return ne(Ln,{children:[I(Ug,{src:sI,alt:"club"}),I(Mg,{$stage:e,src:bg,alt:"character"}),I(hI,{src:oI,alt:"bouncer"}),I(pI,{onClick:()=>t({stage:It.HOME}),children:">"})]})},_I=()=>{const{name:e,update:t}=M.useContext(eo);return ne(Ln,{children:[ne(dI,{children:[I("p",{children:"AWCY"}),I("p",{children:"version 1.0"})]}),ne(fI,{onSubmit:r=>{r.preventDefault(),e&&t({name:e,stage:It.CLUB})},children:[I("label",{htmlFor:"name",children:"Select character name:"}),I("input",{required:!0,id:"name",onChange:r=>t({name:r.target.value}),value:e}),I("button",{type:"submit",children:"Play"})]})]})},wI=({stats:e})=>ne(vI,{children:[ne(Bf,{$stat:"health",max:"100",value:e.health,children:["Health: ",e.health]}),ne(Bf,{$stat:"clout",max:"100",value:e.clout,children:["Clout: ",e.clout]})]}),SI=""+new URL("room-005b6ed8.jpg",import.meta.url).href,EI=()=>{const{stage:e,update:t}=M.useContext(eo),[n,r]=M.useState(!1),i=()=>{t({stats:null}),r(!0)},o=()=>{r(!1),t({stats:{health:80,clout:80}})};return ne(Ln,{children:[I(mI,{onClick:()=>t({stage:It.CLUB}),children:"<"}),I(Ug,{src:SI,alt:"home",onClick:i}),I(Mg,{$stage:e,src:bg,alt:"character"}),n&&ne(gI,{children:[I(Ka,{onClick:o,src:"",alt:"outfit-1"}),I(Ka,{onClick:o,src:"",alt:"outfit-2"}),I(Ka,{onClick:o,src:"",alt:"outfit-3"})]})]})},kI=()=>{const{stats:e,stage:t}=M.useContext(eo);return I(aI,{children:I(lI,{children:I(uI,{children:ne(cI,{children:[t===It.LOGIN&&I(_I,{}),t===It.CLUB&&I(yI,{}),t===It.HOME&&I(EI,{}),e&&t!==It.LOGIN&&I(wI,{stats:e})]})})})})},II=()=>M.useContext(rc)?I(iI,{children:I(kI,{})}):null,TI=()=>ne(rS,{children:[I(rI,{}),I(II,{})]});Ya.createRoot(document.getElementById("root")).render(I(TI,{}));export{qk as A,NI as B,LI as C,PI as D,AI as E,Ln as F,DI as M,Kk as S,rc as U,I as a,xI as b,bI as c,CI as d,OI as e,ne as j,M as r,RI as u};
